...
This works like this: you have a PDF or TXT file with a list of words, an essay, or a passage. It takes the file, extracts only words (excluding symbols and single-letter words like 'a' or 'I'), and also gives you the option to choose whether to include repeated words or not.

This has a randomized feature which will randomize each new test.
...
Final result will show you how many right, wrong, missed etc and point out your wrong letter by letter.
